...
int main()
{
	...
	cout << "\n(Base1*)  &obj  " << (Base1*)&obj << endl;
	cout << "\n(Base2*)&obj  " << (Base2*)&obj << endl;
	cout << "\n(Base3*)&obj  " << (Base3*)&obj << endl;


	//cout << "\n(Base2*)(Base3*)&obj;  " << (Base1*)(Base2*)(Base3*)&obj << endl;
...
//	func = (function)*(    (int*)*(int*)((int*)&obj + 0) + 2    );
	func = (function)*((int*)*((int*)&obj + 0) + 2);                    //   ist way
	func();
	/*cout << (*((int*)*((int*)&obj + 0) + 2)) << endl;
	((function)(*((int*)*((int*)&obj + 0) + 2)))();          //  // 2nd way


	func = (function)*((int*)*((int*)&obj) + 3);
	func();
